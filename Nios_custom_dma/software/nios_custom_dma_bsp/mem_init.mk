...
$(MEM_0)_HIERARCHICAL_PATH := dst_ram
$(MEM_0)_WIDTH := 32
...
.PHONY: dst_ram
dst_ram: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: program
MEM_1 := nios_custom_dma_program
$(MEM_1)_NAME := program
...
$(MEM_1)_HIERARCHICAL_PATH := program
$(MEM_1)_WIDTH := 32
...
.PHONY: program
program: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym

# Memory: src_ram
MEM_2 := nios_custom_dma_src_ram
$(MEM_2)_NAME := src_ram
...
$(MEM_2)_START := 0x00040000
$(MEM_2)_END := 0x00040fff
$(MEM_2)_SPAN := 0x00001000
$(MEM_2)_HIERARCHICAL_PATH := src_ram
$(MEM_2)_WIDTH := 32
...
.PHONY: src_ram
src_ram: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym
