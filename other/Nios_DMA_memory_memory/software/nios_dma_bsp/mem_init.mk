...
$(MEM_0)_HIERARCHICAL_PATH := ocram_0
$(MEM_0)_WIDTH := 32
...
.PHONY: ocram_0
ocram_0: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
...
$(MEM_1)_HIERARCHICAL_PATH := ocram_1
$(MEM_1)_WIDTH := 32
...
.PHONY: ocram_1
ocram_1: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
...
$(MEM_2)_END := 0x00019fff
$(MEM_2)_SPAN := 0x0000a000
$(MEM_2)_HIERARCHICAL_PATH := program
$(MEM_2)_WIDTH := 32
...
.PHONY: program
program: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym
