...
# Memory: data_destination
MEM_0 := dma_data_destination
$(MEM_0)_NAME := data_destination
...
$(MEM_0)_HIERARCHICAL_PATH := data_destination
$(MEM_0)_WIDTH := 32
$(MEM_0)_HEX_DATA_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: data_destination
data_destination: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
...
$(MEM_1)_HIERARCHICAL_PATH := ocram
$(MEM_1)_WIDTH := 32
...
.PHONY: ocram
ocram: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
